...
export class AdminComponent implements OnInit {
  ...
  onFileSelected(event) {
    ...
    if (file) {
        ...
        const upload$ = this.http.post("http://main.ap-south-1.elasticbeanstalk.com/api/csv/upload", formData);

        upload$.subscribe();
    }
}
download(){
  this.http.get("http://main.ap-south-1.elasticbeanstalk.com/api/csv/salesdownload");
}
